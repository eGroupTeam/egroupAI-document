...
const DocumentationLink = ({ classes, link, children, ...other }) => (
  <Typography
    {...other}
    classes={{
      root: classes.root
  ...
  >
    <a className="anchor-link" id={link}>
      {' '}
    </a>
    {children}
    <a className="anchor-link-style" href={`#${link}`}>
...
export default compose(withStyles(styles))(DocumentationLink);
